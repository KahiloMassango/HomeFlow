...
interface MembershipRepository {
    suspend fun createMembership(userId: String, houseId: String, username: String, isOwner: Boolean = false): Membership
    suspend fun deleteMembership(membershipId: String)
    //suspend fun updateMembershipRole(membershipId: String, newRole: String)
    suspend fun getMembershipsByHouse(houseId: String): List<Membership>
    suspend fun getMembershipsByUser(userId: String): List<Membership>
